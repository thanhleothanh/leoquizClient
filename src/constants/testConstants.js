...
export const POST_TEST_RESULT_REQUEST = 'POST_TEST_RESULT_REQUEST';
export const POST_TEST_RESULT_SUCCESS = 'POST_TEST_RESULT_SUCCESS';
export const POST_TEST_RESULT_FAIL = 'POST_TEST_RESULT_FAIL';
