  ...
  return (
    <div>
      {transition((style) => (
        <animated.div
          style={style}
          className='flex flex-col lg:items-baseline lg:flex-row h-auto min-h-screen w-full mt-8 sm:px-10 lg:px-7 lg:space-x-2 space-y-16 lg:space-y-0'
        >
          <Meta
            title='About You'
              ...
              <>
                ...
                <div className='flex justify-center mx-1'>
                  <table className='table-auto w-full'>
                    <thead>
                      <tr>
                        <th className='tableHead py-3 w-1/12 rounded-tl-2xl'>
                          #
                        </th>
